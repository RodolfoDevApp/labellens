...
export type ProductNotFoundWorkerConfig = {
...
export function readProductNotFoundWorkerConfig(): ProductNotFoundWorkerConfig {
  const config: ProductNotFoundWorkerConfig = {
    awsRegion: process.env.AWS_REGION ?? "us-east-1",
    labelLensTableName: process.env.LABEL_LENS_TABLE ?? "LabelLensTable",
    productNotFoundQueueUrl: readRequired("PRODUCT_NOT_FOUND_QUEUE_URL"),
