...
export class LabelLensOperationalParametersConstruct extends Construct {
  constructor(scope: Construct, id: string, props: LabelLensOperationalParametersConstructProps) {
    ...
    new StringParameter(this, "DeploymentModeParameter", {
      parameterName: `/${props.resourcePrefix}/deployment/mode`,
      stringValue: props.deploymentMode,
    });

    new StringParameter(this, "DeploymentImageTagParameter", {
      parameterName: `/${props.resourcePrefix}/deployment/image-tag`,
    ...
    new StringParameter(this, "AuthModeParameter", {
      parameterName: `/${props.resourcePrefix}/runtime/auth-mode`,
      stringValue: "cognito-jwt",
    });
  }
}
